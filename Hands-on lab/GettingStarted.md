...
1. When you click on Azure portal, edge browser welcome screen will come up, select **Get started**.
   ...
   [azure portal.](media/edge-get-started-window.png "Get started")
   
1. On next window, click on **Confirm**.

   [azure portal.](media/edge-confirm.png "Confirm")
   
1. Now, you can close the popup which is coming up.

   [azure portal.](media/edge-continue.png "Confirm")
   
1. Now, you will see two tabs in edge browser, close first tab named with **Microsoft Edge**.

   [azure portal.](media/click-sign-in-to-microsoft-azure-tab.png "Close Tab")
...
1. Now enter the following password and click on **Sign in**.
   * Password: <inject key="AzureAdUserPassword"></inject>
     ...
     [azure portal.](media/azure-login-enter-password.png "Enter Email")
